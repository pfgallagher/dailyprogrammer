...
var titleCase = function (title, exceptions) {
    return title
        .toLowerCase()
        .split(" ")
        .map(function (word, i) {
        return !i || !exceptions.includes(word) ? capitalize(word) : word;
    })
        .join(" ");
};
...
console.log(titleCase("THE vitamins ARE IN my fresh CALIFORNIA raisins", [
    "are",
    "is",
    "in",
    "your",
