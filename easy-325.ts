/*
	Skipping this one for now, as it seems like it will take way longer than I
	allocate for doing these challenges every morning.
*/
...
// You traverse a color by following a sequence of colors. For example this maze
// can be solved by the sequence 'orange -> green'. Then you would have something like this
