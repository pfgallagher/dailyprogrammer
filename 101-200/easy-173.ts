interface IConversionObject {
	[unit: string]: number;
}

interface IConversionRatios {
	meters: IConversionObject;
	inches: IConversionObject;
	miles: IConversionObject;
	attoparsecs: IConversionObject;
	kilograms: IConversionObject;
	pounds: IConversionObject;
	ounces: IConversionObject;
	"hogsheads of Beryllium": IConversionObject;
}

const ratios: IConversionRatios = {
	attoparsecs: {
		inches: 1.215,
...
const convertUnits = (
	n: number,
	oldU: keyof IConversionRatios,
	newU: keyof IConversionRatios,
): string =>
	ratios[oldU][newU]
